// ==================== Elementos da Página ====================
// Pode ser movido para um arquivo chamado `domElements.js`
...
// ==================== Áudios ====================
// Pode ser movido para um arquivo chamado `audio.js`
...
// ==================== Variáveis do Jogo ====================
// Pode ser movido para um arquivo chamado `gameState.js`
let planetas = 0;
let planetaAtual = 0;
...
// Pode ser movido para um arquivo chamado `storage.js`
...
// Pode ser movido para um arquivo chamado `formatters.js`
...
// Pode ser movido para um arquivo chamado `uiUpdater.js`
...
// ==================== Lógica do OVNI ====================
// Pode ser movido para um arquivo chamado `ovniLogic.js`
...
// ==================== Eventos de Clique ====================
// Pode ser movido para um arquivo chamado `eventHandlers.js`
...
// ==================== Lógica de Reset ====================
// Pode ser movido para um arquivo chamado `resetLogic.js`
...
// ==================== Lógica de Compra ====================
// Pode ser movido para um arquivo chamado `purchaseLogic.js`
btnPoderes.forEach((btn, index) => {
...
// ==================== Lógica de Progresso ====================
// Pode ser movido para um arquivo chamado `progressLogic.js`
let progresso = 0;
...
// ==================== Lógica de Menus ====================
// Pode ser movido para um arquivo chamado `menuLogic.js`
...
// ==================== Ganho Passivo ====================
// Pode ser movido para um arquivo chamado `passiveGain.js`
...
// ==================== Inicialização ====================
// Pode ser movido para um arquivo chamado `init.js`
